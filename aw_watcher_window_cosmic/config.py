...
def load_config():
    return load_config_toml("aw-watcher-window-cosmic", default_config)[
        "aw-watcher-window-cosmic"
    ]
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="A window watcher for ActivityWatch on COSMIC (Wayland).\nSupports Wayland compositors implementing wlr-foreign-toplevel-management-v1 protocol."
    )
